...
패턴에 맞춰 조율합니다.</p></div>
            ...
            <div className="selected-booking always-visible">
              {selectedDate && <><button type="button" className="calendar-back" onClick={() => { setSelectedDate(null); setSelectedTimeValue(""); setSent(false); }}>← 날짜 다시 선택</button><p className="selected-date selected-date-card">선택한 날짜 <strong>{calendarYear}년 {calendarMonth + 1}월 {selectedDate}일</strong></p></>}
